...
class NonHolonomicHandEmbodiment(NonHolonomicEmbodiment):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.finger_thickness = 0.33 * self.radius #originally 0.25
        self.finger_upper_length = 1.3 * self.radius #originally 1.1
        self.finger_lower_length = 0.7 * self.radius

        self.robot_color = COLORS_RGB["hand"]
    ...
    def set_action(
        ...
        assert len(action) == NonHolonomicHandEmbodiment.DOF
    ...
    def pre_draw(self) -> None:
        ...
        for finger_xform, finger_body in zip(self.finger_xforms, self.finger_bodies):
            ...
            #print("here")
            with open("/home/user_117/user_1/xirl/xyz.txt", "a") as fp:
                fp.write(f"\n\t\"index\":\" \",\n\t\"x\": \"{(finger_body.position.x)*10}\",\n\t\"y\": {finger_body.position.y*10}\",\n\t\"z\": \"0\"\n?," )
            #maya@rahel
